...
export default function DatabaseStories({ characters }: Props): JSX.Element {
  ...
  return (
    <Layout>
      <Meta
        title="EX Characters stories - Database"
        description="EX Characters stories"
        ...
        <div className="relative">
          <div className="flex items-center gap-y-4 gap-x-4 bg-grey-dark border border-beige border-opacity-50 p-4 mb-8">
            <FormControl className="flex-1">
              <InputLabel id="season-index">EX Character</InputLabel>
              <Select
...
export function ExCharacterStory({ character }: { character: character }) {
  return (
    <div>
