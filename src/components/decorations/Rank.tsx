...
export default function Rank({rank, ...all}: {rank: ranks}): JSX.Element {
    let img: StaticImageData
    switch(rank) {
        case "S": img = rankS; break;
        case "A": img = rankA; break;
        case "B": img = rankB; break;
        case "C": img = rankC; break;
        case "D": img = rankD; break;
        case "E": img = rankE; break;
        default: img = rankE;
    }
    return <Image
        {...all}
