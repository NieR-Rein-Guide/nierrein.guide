...
function WeaponCalculator(): JSX.Element {
    ...
    useEffect(() => {
        setTargetWeaponLevel(capValue(targetWeaponLevel, 1, getMaxTargetWeaponLevel()));
        setCurrentWeaponLevel(capValue(currentWeaponLevel, 1, targetWeaponLevel));
        setSingleMaterialValues(getSingleMaterialValues());
    }, [weaponRarity]);
    ...
    function getAccumulatedExp() {
        if (targetWeaponLevel - currentWeaponLevel == 0)
            return 0;

        let result = 0;
        for (let index = currentWeaponLevel - 1; index < targetWeaponLevel - 1; index++) {
                ...
                <div>
                    <label>
                        ...
                        <input
                            ...
                            onChange={(e) => setCurrentWeaponLevel(capValue(Number(e.target.value), 1, targetWeaponLevel))}
                        />
                    </label>
                </div>
                <div>
                    <label>
                        ...
                        <input
                            ...
                            onChange={(e) => setTargetWeaponLevel(capValue(Number(e.target.value), 1, getMaxTargetWeaponLevel()))}
                        />
                    </label>
                </div>
                <div>
                    <label>
                        ...
                        <input
                            ...
                            min="2"
                            max="4"
                            onChange={(e) => setWeaponRarity(capValue(Number(e.target.value), 2, 4))}
                        />
                    </label>
                </div>
                <div>
